...
if __name__ == "__main__":
    start = time()
    threshold = 0.8
    snap = 'dios-erc-gpu_2021_03_16_14_32_11_3D_resnet34_UNet'

    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset_root', type=Path, default='../../../Data/µCT/full_dataset/images')
    #parser.add_argument('--dataset_root', type=Path, default='/media/santeri/Transcend1/Full samples/')
    parser.add_argument('--save_dir', type=Path, default=f'/media/santeri/data/RabbitSegmentation/Data/µCT/predictions_full/{snap}')
    ...
    parser.add_argument('--largest', type=bool, default=True)
    ...
    for idx, sample in enumerate(samples):
        ...
        # Load image stacks
        data_xz, files = load(str(args.dataset_root / sample), rgb=True, axis=(1, 2, 0))
